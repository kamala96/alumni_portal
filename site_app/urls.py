...
urlpatterns = [
    ...
    path('user_create_account', views.user_create_account, name='user_create_account'),
    path('user_create_login', views.login_view, name='user_create_login'),
    path('user_logout/', views.logout_view, name='user_logout'),
    path('usre_profile_image/', views.usre_profile_image, name='usre_profile_image'),
    path('alumni_update_password/', views.alumni_update_password, name='alumni_update_password'),
    path('alumni_update_profile/', views.alumni_update_profile, name='alumni_update_profile'),
